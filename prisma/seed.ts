...
const MAOS_BLOCK_POLYGONS: Record<string, number[][][]> = {
  ...
  Block_F: [
    [
      [109.1773592121075, -7.611342881224713],
      [109.1773737758401, -7.611359429101592],
      [109.1773776807949, -7.611386311752251],
      [109.1773630498622, -7.611403719554285],
      [109.1773469614697, -7.611398437159247],
      [109.177330014909, -7.611495504318018],
      [109.1773366380309, -7.611504452168745],
      [109.1773776378928, -7.611510057779936],
      [109.177432824477, -7.611489381964245],
      [109.1774944064631, -7.611441154032259],
      [109.1775058737761, -7.611376273014706],
      [109.1775169383066, -7.611322514296809],
      [109.1775075576823, -7.611281043678808],
      [109.1774733949715, -7.611251319420333],
      [109.1773741892633, -7.611269623239441],
      [109.1773592121075, -7.611342881224713],
    ],
  ],
};
...
async function main() {
  ...
  await prisma.systemSetting.upsert({
    ...
    update: { value: { min: 2, max: 8 } },
    create: { key: "safetyTimeout", value: { min: 2, max: 8 } },
  });

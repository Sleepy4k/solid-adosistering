...
function useNavigate(): (to: string | number, options?: Partial<NavigateOptions>) => void;
...
function useMatch<S extends string>(path: () => S, matchFilters?: MatchFilters): Accessor<PathMatch | undefined>;
...
function useBeforeLeave(listener: (e: BeforeLeaveEventArgs) => void): void;
...
function lazy<T extends Component>(fn: () => Promise<{ default: T }>): T & { preload: () => Promise<{ default: T }> };
```

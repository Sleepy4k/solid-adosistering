...
function LocationModal(props: { initial?: Item; onClose: () => void; onSaved: () => void }) {
  ...
  const [description, setDescription] = createSignal<string>(props.initial?.description ?? "");
      ...
      <form onSubmit={save} class="flex flex-col gap-4">
        ...
        <div class="flex flex-col gap-1.5">
          ...
          <ImageUpload
            ...
            placeholder="/uploads/cms/lokasi.jpg atau https://..."
            previewContainerClass="mt-1 h-24 w-full overflow-hidden rounded-lg border border-slate-200 relative"
